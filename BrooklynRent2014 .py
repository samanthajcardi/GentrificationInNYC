# -*- coding: utf-8 -*-
"""
Created on Mon May  2 17:06:31 2016
...
with open ('BrooklynRent2014.csv', 'rU') as f:
  ...
  #  l=reader.next()
    ...
    p=Bar(d,values='values',label=CatAttr(sort=False, columns=['labels']), xlabel='Gross Rent', 
          ylabel='Number of People in Thousands', agg='min', title='Brooklyn Rent 2014', color='darkseagreen')
          
    output_file("BrooklynRent2014.html", title="Brooklyn Rent 2014")
    show (p)
