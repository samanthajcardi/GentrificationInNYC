# -*- coding: utf-8 -*-
"""
Created on Sun May  1 19:53:55 2016

@author: samanthacardi
"""

#Graph of Bronx Income in 2014
import csv
...
with open ('BRONXgeneral2014H.csv', 'rU') as f:
    ...
    p=Bar(d,values='values',label=CatAttr(sort=False, columns=['labels']), xlabel='Income', 
          ylabel='Number of People in Thousands', agg='min', title='Bronx Income 2014',
          color='lightsalmon')


    output_file("BronxIncome2014.html")
